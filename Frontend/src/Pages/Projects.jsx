...
const projects = [
  ...
  },
  {
   ...
   {
    title: "LMS for SAT SOFTWARE HOUSE",
    desc: "A professional LMS for SAT Software House, built with React, featuring course management, user authentication, and interactive learning modules.",
    tech: ["React", "Framer Motion", "Tailwind"],
    image:SATimg ,
    link: "#",
  },
            ...
            <div className="p-8 flex flex-col">
              <div className="flex flex-wrap gap-2 mb-4">
                {project.tech.map((tag, i) => (
                  <span
                    key={i}
                    className="text-[10px] uppercase tracking-widest bg-white/5 text-[#00d4ff] px-3 py-1 rounded-full border border-[#00d4ff]/20"
                  >
                    {tag}
                  </span>
                ))}
              ...
              <a
                ...
                className="flex items-center justify-between px-6 py-4 rounded-2xl font-bold text-white transition-all duration-300 bg-white/5 border border-white/10 hover:bg-[#00d4ff] hover:text-black group/btn"
              >
